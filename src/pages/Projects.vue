...
onBeforeUnmount(() => {
  // la directiva se encarga de limpiar sus observers
});
</script>
  ...
  <article class="tech-stack">
    ...
    <section class="tech-section language-section">
      ...
      <div class="projects-grid">
        <div
          class="project-card"
          v-for="(project, index) in developWeb"
          :key="project.title"
          v-intersect
        ...
        >
          ...
          <div class="project-content">
            ...
            <div class="project-tech">
              <span
                class="tech-tag"
                v-for="skill in project.techStack"
                :key="skill"
              >
                {{ skill }}
              </span>
      ...
      <div class="projects-grid">
        <div
          class="project-card project-card--nocode"
          v-for="(project, index) in noCodeProjects"
          :key="project.title"
          v-intersect
          :style="{ '--delay': `${index * 0.12 + 0.2}s` }"
        >
          <div class="project-media">
            <img
              :src="project.image"
